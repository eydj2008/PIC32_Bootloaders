...
ifeq "$(wildcard nbproject/Makefile-local-32MX1xx_2xx.mk)" "nbproject/Makefile-local-32MX1xx_2xx.mk"
include nbproject/Makefile-local-32MX1xx_2xx.mk
endif
endif
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-32MX1xx_2xx.mk dist/${CND_CONF}/${IMAGE_TYPE}/Demo_App_Explorer16.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/Demo_App_Explorer16.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    ../linker_scripts/app_32MX250F128D.ld
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_ICD3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Demo_App_Explorer16.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}           -mreserve=data@0x0:0x1FC -mreserve=boot@0x1FC00490:0x1FC00BEF -mreserve=boot@0x1FC00490:0x1FC00BEF  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_ICD3=1,-L"..",-Map="${DISTDIR}/Demo_App_Explorer16.X.${IMAGE_TYPE}.map"
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/32MX1xx_2xx
	${RM} -r dist/32MX1xx_2xx
